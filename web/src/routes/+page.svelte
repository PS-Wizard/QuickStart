    ...
    <div class="grid-12 py-8">
        <div class="col-span-4 sm:col-span-8 lg:col-span-12 text-center">
            ...
            <p class="text mx-auto">
                ...
                Inventore, similique, dolorum sunt placeat laboriosam obcaecati
                libero magnam, id quibusdam odio natus praesentium deserunt
                voluptatum? Neque nam eos quam aliquid adipisci.
            </p>
        </div>
    </div>
    <div class="grid-12">
